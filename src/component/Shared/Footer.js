            ...
            <div className="footer-bg py-5">
                <div className="container text-white">
                    <div className="text-center">
                        <h1 className="text-warning">Ed-Tech</h1>
                    ...
                    <div className="row">
                        ...
                        <div class="row text-center">
                            <div class="col">
                                <h5 class="text-light">Copyright 2022 &copy; Ed-Tech</h5>
                                <p>Design By: <a className="text-warning" href="https://www.facebook.com/ih75754/">Ibrahim Hossain</a></p>
                            </div>
                        </div>
                    </div>
                </div>
